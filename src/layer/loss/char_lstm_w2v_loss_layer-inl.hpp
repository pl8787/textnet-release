#ifndef TEXTNET_LAYER_CHAR_LSTM_W2V_LOSS_LAYER_INL_HPP_
#define TEXTNET_LAYER_CHAR_LSTM_W2V_LOSS_LAYER_INL_HPP_
...
// this layer is disigned for trainig char lstm language model
