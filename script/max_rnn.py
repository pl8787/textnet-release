...
def gen_rnn(d_mem, init_iterval):
    ...
    if dataset == 'mr':
        ...
        g_filler_t = gen_uniform_filter_setting(init_iterval/2)
    ...
    g_layer_setting['t_filler'] = g_filler_t
    ...
    # layer = {}
    # layers.append(layer) 
    # layer['bottom_nodes'] = ['word_low_rep_seq']
    # layer['top_nodes'] = ['word_act_seq']
    # layer['layer_name'] = 'word_act'
    # layer['layer_type'] = 3
    # layer['setting'] = {}
    ...
    layers.append(layer) 
    layer['bottom_nodes'] = ['word_rep_seq']
    layer['top_nodes'] = ['max_rnn_seq']
    layer['layer_name'] = 'max_rnn'
    layer['layer_type'] = 31 
    setting = copy.deepcopy(g_layer_setting)
    layer['setting'] = setting
    setting['d_mem'] = d_mem
    ...
    layer = {}
    layers.append(layer) 
    layer['bottom_nodes'] = ['max_rnn_seq']
...
for d_mem in [100]:
    net = gen_rnn(d_mem = d_mem, init_iterval = 0.0001)
