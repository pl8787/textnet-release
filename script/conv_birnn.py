...
def gen_conv_birnn(d_mem, init, l2, lr, dataset, batch_size):
    ...
    layer['top_nodes'] = ['l_rnn_seq']
    layer['layer_name'] = 'l_rnn'
    layer['layer_type'] = 27
    setting = copy.deepcopy(g_layer_setting)
    layer['setting'] = setting
    setting['d_mem'] = d_mem
    ...
    layers.append(layer) 
    layer['bottom_nodes'] = ['word_rep_seq']
    layer['top_nodes'] = ['r_rnn_seq']
    layer['layer_name'] = 'r_rnn'
    layer['layer_type'] = 27
    setting = copy.deepcopy(g_layer_setting)
    layer['setting'] = setting
    setting['d_mem'] = d_mem
    ...
    layer = {}
    layers.append(layer) 
    layer['bottom_nodes'] = ['l_rnn_seq', 'r_rnn_seq']
    layer['top_nodes'] = ['bi_rnn_seq']
